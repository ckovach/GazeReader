...
% Last Modified by GUIDE v2.5 22-Dec-2007 16:57:20
...
if ~isempty(datainfo)
    ...
    setnums = cellfun(@num2str,mat2cell(1:length(datainfo),ones(1,length(datainfo))));
...
parent = getappdata(handles.figure1,'parent');
DataSets = getappdata(handles.dataList,'value')-1;
