...
% Last Modified by GUIDE v2.5 07-Jan-2008 21:28:31
...
% --------------------------------------------------------------------
function triaManager_menu_Callback(hObject, eventData, handles)
% hObject    handle to triaManager_menu (see GCBO)
% eventData  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
if ~isempty(roiData.groups(currentRoiGroup).pos)
    ...
    insiderois =  roiData.groups(currentRoiGroup).ismember( roiData.groups(currentRoiGroup), currpt,selectionTol/sqrt(abs(det(ax2fig))));
...
% else
%     
%     insiderois =  roiData.groups(currentRoiGroup).ismember( roiData.groups(currentRoiGroup), currpt);
%     if ~any(insiderois)
%         return
%     end
end
...
% --------------------------------------------------------------------
function PlotManager_Callback(hObject, eventdata, handles)
% hObject    handle to PlotManager (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
